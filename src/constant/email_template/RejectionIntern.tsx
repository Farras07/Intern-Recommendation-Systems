      ...
      <Tailwind>
        ...
        <div style={{ backgroundColor: '#458FFF', padding: '40px 0' }}>
          ...
          >
            ...
            >
              🙏 We&apos;re Sorry. Your Application Rejected 🙏
            </h1>
            <Img
              src='https://img.icons8.com/emoji/96/folded-hands-medium-light-skin-tone.png'
              width='125'
              height='120'
              alt='Handshake'
            ...
            >
              ...
              {batch} on {role} , You are rejected to join our team. However
              keep looking forward on our next recruitment intern!.
            </Text>
          </Section>
        </div>
      </Tailwind>
