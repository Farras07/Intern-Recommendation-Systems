...
const AcceptanceInternEmail: React.FC<InterviewInviteEmailProps> = ({
  name,
  batch,
  role,
}) => {
        ...
        <div style={{ backgroundColor: '#458FFF', padding: '40px 0' }}>
          ...
          >
            ...
            >
              ...
              {batch} on {role} , you are one of the selected candidates who
              accepted to join our team. Congrats!. Please reach out the Admin
...
export default AcceptanceInternEmail;
