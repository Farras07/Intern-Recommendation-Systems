...
type CollapsibleContainerProps = {
    ...
    activeIndex: number;
    className?: string;
    colSpan?: number | keyof typeof GridFullValue;
    rowSpan?: number | keyof typeof GridFullValue;
    colStart?: number;
    ...
    return(
        <div 
            className={cn(
                ...
                activeIndex === selfIndex && collapsible && `col-span-${colSpan} row-span-${rowSpan} col-start-${colStart}`
            )}
        >
