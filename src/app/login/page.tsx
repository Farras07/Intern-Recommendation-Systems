...
export default function Login() {
  ...
  return (
    <section className='grid grid-cols-2 h-screen w-screen'>
      <section className='bg-black col-span-full flex flex-col items-center justify-center gap-2 max-h-[100vh] px-3 md:col-span-1 '>
        <Typography
          variant='h4'
          weight='bold'
        ...
        >
          We&apos;re excited to have you here. Sign in to start make data based
          decision!
        </Typography>
        <div className='mt-4 flex flex-col items-center gap-8 md:hidden'>
          ...
          <div>
            ...
            <div
              className={`w-[17rem] h-[100px] max-w-[1000px] flex flex-col gap-5 ${role === 'Judge' ? 'flex' : 'hidden'} `}
            >
